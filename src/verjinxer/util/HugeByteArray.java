...
/**
 * This class provides huge (&lt; 2 Giga Elements) arrays of basic type byte. Since Java limits
 ...
 * arrays with more than 2^31 ~ 2 billion elements. This particular class provides huge byte
 * arrays.
 * 
 * @author Sven Rahmann
 */
public class HugeByteArray {
   ...
   private final static int BYTESPERELEMENT = Byte.SIZE/8;
   ...
   public HugeByteArray(final long length) {
      ...
      if (bins > 0) {
         arrays[bins - 1] = new byte[(int)(length & BITMASK_LOW)];
   ...
   /**
    * Reads a part of a file on disk into a part of this HugeByteArray. If the size of this array
    ...
    * @param fpos
    *           file index (in 'byte' units) at which to start reading
