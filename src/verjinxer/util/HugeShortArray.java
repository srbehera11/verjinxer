 ...
 * HugeByteArray 
 * 
 * Modify this class, do not modify the four above mentioned classes, as they are automatically generated!

 * Automatic generation of huge arrays of primitive types: In this process, Short is replaced by
 * each of {Long, Int, Byte}, and short is replaced by each of {long, int, byte}. Each of these
 * automatically generated classes can then be compiled. Also, everything between lines that contain
 * 'begincut' and 'endcut' tags is removed when replacing the generic short by a basic numeric type.
 * 
 * ==endcut
 */
...
/**
 * This class provides huge (&lt; 2 Giga Elements) arrays of basic type short. Since Java limits
 ...
 * arrays with more than 2^31 ~ 2 billion elements. This particular class provides huge short
 * arrays.
 * 
 * @author Sven Rahmann
 */
public class HugeShortArray {
   ...
   private final static int BYTESPERELEMENT = Short.SIZE / 8;
   ...
   /**
    * creates a new HugeShortArray
    * 
    * @param size
    *           number of elements in the array
    */
   public HugeShortArray(final long length) {
      this.length = length;
    ...
    *           the existing array
    */
   public HugeShortArray(final HugeShortArray other) {
      length = other.length;
      bins = other.bins;
      arrays = new short[bins][];
    ...
    */
   public long binarySearch(final short key, final long fromIndex, final long toIndex) {
      long low = fromIndex;
      long high = toIndex - 1;
   ...
   /**
    * Reads a part of a file on disk into a part of this HugeShortArray. If the size of this array
    ...
    * @param fpos
    *           file index (in 'short' units) at which to start reading
