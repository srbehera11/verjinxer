...
public class QGramIndex {
   ...
   final int[]       qbck;   // bucket boundaries
   IntBuffer   qpos;   // q-gram positions as buffer
   int[]       qposa;   // q-gram positions as array
   final boolean external;

   public QGramIndex(final Globals gl, final String qposfile, final String qbckfile, boolean external) {
      this.g = gl;
