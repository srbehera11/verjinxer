...
public class SequenceWriter extends Sequence{
   ...
   public void addInfo(String header, long length, long ssp) {
      ...
      if(length < minSequenceLength) minSequenceLength = length;
      if(length > maxSequenceLength) maxSequenceLength = length;
   ...
   public long[] getLengths(){
      ...
      int i = 0;
      for(long l:sequenceLengths) lengths[i++] = l;
      return lengths;
   }
